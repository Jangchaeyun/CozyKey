...
const getCurrentResidences = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const residencesWithFormatedLocation = yield Promise.all(properties.map((property) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
        ...
        res.json(residencesWithFormatedLocation);
    }
    catch (err) {
        res
            .status(500)
...
const addFavoriteProperty = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!existingFavorites.some((fav) => fav.id === propertyIdNumber)) {
            ...
            res.status(409).json({ message: "이미 즐겨찾기에 추가된 속성입니다." });
        }
    }
    catch (err) {
        res
