...
exports.getMangerProperties = exports.updateManager = exports.createManager = exports.getManager = void 0;
...
const getMangerProperties = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { cognitoId } = req.params;
        ...
        const propertiesWithFormatedLocation = yield Promise.all(properties.map((property) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
        ...
        res.json(propertiesWithFormatedLocation);
    }
    catch (err) {
        res
            .status(500)
...
exports.getMangerProperties = getMangerProperties;
